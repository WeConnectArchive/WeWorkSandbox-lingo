...
func (f Float64) To(value float64) lingo.Set {
	return expr.NewSet(f, expr.NewValue(value))
}

func (f Float64) ToExpr(setExp lingo.Expression) lingo.Set {
	return expr.NewSet(f, setExp)
}

func (f Float64) Eq(equalTo float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.Eq, expr.NewValue(equalTo))
}

func (f Float64) EqPath(equalTo lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.Eq, equalTo)
}

func (f Float64) NotEq(notEqualTo float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.NotEq, expr.NewValue(notEqualTo))
}

func (f Float64) NotEqPath(notEqualTo lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.NotEq, notEqualTo)
}

func (f Float64) LT(lessThan float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.LessThan, expr.NewValue(lessThan))
}

func (f Float64) LTPath(lessThan lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.LessThan, lessThan)
}

func (f Float64) LTOrEq(lessThanOrEqual float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.LessThanOrEqual, expr.NewValue(lessThanOrEqual))
}

func (f Float64) LTOrEqPath(lessThanOrEqual lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.LessThanOrEqual, lessThanOrEqual)
}

func (f Float64) GT(greaterThan float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.GreaterThan, expr.NewValue(greaterThan))
}

func (f Float64) GTPath(greaterThan lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.GreaterThan, greaterThan)
}

func (f Float64) GTOrEq(greaterThanOrEqual float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.GreaterThanOrEqual, expr.NewValue(greaterThanOrEqual))
}

func (f Float64) GTOrEqPath(greaterThanOrEqual lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.GreaterThanOrEqual, greaterThanOrEqual)
}

func (f Float64) IsNull() lingo.ComboExpression {
	return operator.NewOperator(f, operator.Null)
}

func (f Float64) IsNotNull() lingo.ComboExpression {
	return operator.NewOperator(f, operator.NotNull)
}

func (f Float64) In(values ...float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.In, expr.NewValue(values))
}

func (f Float64) InPaths(values ...lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.In, values...)
}

func (f Float64) NotIn(values ...float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.NotIn, expr.NewValue(values))
}

func (f Float64) NotInPaths(values ...lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.NotIn, values...)
}

func (f Float64) Between(first, second float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.Between, expr.NewValue(first).And(expr.NewValue(second)))
}

func (f Float64) BetweenPaths(first, second lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(f, operator.Between, operator.NewOperator(first, operator.And, second))
}

func (f Float64) NotBetween(first, second float64) lingo.ComboExpression {
	return operator.NewOperator(f, operator.NotBetween, expr.NewValue(first).And(expr.NewValue(second)))
}

func (f Float64) NotBetweenPaths(first, second lingo.Expression) lingo.ComboExpression {
