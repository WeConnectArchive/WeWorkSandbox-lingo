...
func (b Binary) To(value []byte) lingo.Set {
	return expr.NewSet(b, expr.NewValue(value))
}

func (b Binary) ToExpr(setExp lingo.Expression) lingo.Set {
	return expr.NewSet(b, setExp)
}

func (b Binary) Eq(equalTo []byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.Eq, expr.NewValue(equalTo))
}

func (b Binary) EqPath(equalTo lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.Eq, equalTo)
}

func (b Binary) NotEq(notEqualTo []byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.NotEq, expr.NewValue(notEqualTo))
}

func (b Binary) NotEqPath(notEqualTo lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.NotEq, notEqualTo)
}

func (b Binary) LT(lessThan []byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.LessThan, expr.NewValue(lessThan))
}

func (b Binary) LTPath(lessThan lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.LessThan, lessThan)
}

func (b Binary) LTOrEq(lessThanOrEqual []byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.LessThanOrEqual, expr.NewValue(lessThanOrEqual))
}

func (b Binary) LTOrEqPath(lessThanOrEqual lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.LessThanOrEqual, lessThanOrEqual)
}

func (b Binary) GT(greaterThan []byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.GreaterThan, expr.NewValue(greaterThan))
}

func (b Binary) GTPath(greaterThan lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.GreaterThan, greaterThan)
}

func (b Binary) GTOrEq(greaterThanOrEqual []byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.GreaterThanOrEqual, expr.NewValue(greaterThanOrEqual))
}

func (b Binary) GTOrEqPath(greaterThanOrEqual lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.GreaterThanOrEqual, greaterThanOrEqual)
}

func (b Binary) IsNull() lingo.ComboExpression {
	return operator.NewOperator(b, operator.Null)
}

func (b Binary) IsNotNull() lingo.ComboExpression {
	return operator.NewOperator(b, operator.NotNull)
}

func (b Binary) In(values ...[]byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.In, expr.NewValue(values))
}

func (b Binary) InPaths(values ...lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.In, values...)
}

func (b Binary) NotIn(values ...[]byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.NotIn, expr.NewValue(values))
}

func (b Binary) NotInPaths(values ...lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.NotIn, values...)
}

func (b Binary) Between(first, second []byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.Between, expr.NewValue(first).And(expr.NewValue(second)))
}

func (b Binary) BetweenPaths(first, second lingo.Expression) lingo.ComboExpression {
	return operator.NewOperator(b, operator.Between, operator.NewOperator(first, operator.And, second))
}

func (b Binary) NotBetween(first, second []byte) lingo.ComboExpression {
	return operator.NewOperator(b, operator.NotBetween, expr.NewValue(first).And(expr.NewValue(second)))
}

func (b Binary) NotBetweenPaths(first, second lingo.Expression) lingo.ComboExpression {
