...
func (t Time) Eq(equalTo time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.Eq, expression.NewValue(equalTo))
}
...
func (t Time) NotEq(notEqualTo time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.NotEq, expression.NewValue(notEqualTo))
}
...
func (t Time) LT(lessThan time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.LessThan, expression.NewValue(lessThan))
}
...
func (t Time) LTOrEq(lessThanOrEqual time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.LessThanOrEqual, expression.NewValue(lessThanOrEqual))
}
...
func (t Time) GT(greaterThan time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.GreaterThan, expression.NewValue(greaterThan))
}
...
func (t Time) GTOrEq(greaterThanOrEqual time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.GreaterThanOrEqual, expression.NewValue(greaterThanOrEqual))
}
...
func (t Time) In(values ...time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.In, expression.NewValue(values))
}
...
func (t Time) NotIn(values ...time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.NotIn, expression.NewValue(values))
}
...
func (t Time) Between(first, second time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.Between, expression.NewValue(first).And(expression.NewValue(second)))
}
...
func (t Time) NotBetween(first, second time.Time) core.ComboExpression {
	return operator.NewOperator(t, operator.NotBetween, expression.NewValue(first).And(expression.NewValue(second)))
}
