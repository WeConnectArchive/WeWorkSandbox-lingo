...
func NewInt8PathWithAlias(e core.Table, name, alias string) Int8 {
	return Int8{
		entity: e,
		name:   name,
		alias:  alias,
...
func NewInt8Path(e core.Table, name string) Int8 {
...
func (i Int8) GetSQL(d core.Dialect) (core.SQL, error) {
