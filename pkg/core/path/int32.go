...
func NewInt32PathWithAlias(e core.Table, name, alias string) Int32 {
	return Int32{
		entity: e,
		name:   name,
		alias:  alias,
...
func NewInt32Path(e core.Table, name string) Int32 {
...
func (i Int32) GetSQL(d core.Dialect) (core.SQL, error) {
