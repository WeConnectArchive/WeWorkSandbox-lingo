...
var _ = Describe("Int16", func() {
	...
	Context("NewInt16PathWithAlias", func() {
		...
		JustBeforeEach(func() {
			p = path.NewInt16PathWithAlias(e, name, alias)
		})

		It("Returns a `Int16Path`", func() {
			Expect(p).To(BeAssignableToTypeOf(path.Int16Path{}))
		})
	...
	Context("NewInt16Path", func() {
		...
		Context("Between", func() {
			...
			BeforeEach(func() {
				firstValue = math.MinInt16
				secondValue = math.MaxInt16
			})
